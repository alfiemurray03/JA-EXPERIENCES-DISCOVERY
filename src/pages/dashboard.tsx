...
export default function DashboardPage() {
  ...
  return <><Helmet><title>Dashboard — JA Plan Studio</title><meta name="robots" content="noindex,nofollow"/></Helmet><DashboardLayout><main className="max-w-7xl mx-auto px-6 py-10 space-y-8">
