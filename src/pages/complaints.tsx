...
export default function ComplaintsPolicyPage() {
  return <>
    <Helmet>
      <title>Complaints Policy — JA Plan Studio</title>
      <meta name="description" content="How to make, escalate and resolve a complaint about JA Plan Studio." />
    ...
    <main className="min-h-screen bg-background">
      <article className="mx-auto max-w-3xl px-6 py-12 text-foreground">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          <section><p>JA Plan Studio is operated by JA Group Services Ltd (company number 16314179), registered at 167–169 Great Portland Street, 5th Floor, London, W1W 5PF. We aim to handle complaints fairly, accessibly and without unreasonable delay.</p></section>
          ...
          <section><h2 className="mb-2 text-lg font-semibold text-foreground">6. Contact</h2><p>Escalations may be sent to <a className="text-primary underline" href={`mailto:${GROUP_CONTACT_EMAIL}`}>{GROUP_CONTACT_EMAIL}</a> with “JA Plan Studio complaint escalation” in the subject line.</p></section>
        </div>
