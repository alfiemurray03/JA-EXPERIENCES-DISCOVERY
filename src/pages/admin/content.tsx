...
const SEED_CONTENT: ContentItem[] = [
  {
    ...
    body: 'Build personalised plans step by step. Planyx provides guided builders for destinations, itineraries, experiences, budgets, accessibility and practical travel preparation.',
  ...
  },
  {
    ...
    body: 'This Privacy Policy explains how Planyx collects, uses, and protects your personal data in accordance with the UK GDPR and the Data Protection Act 2018.',
  ...
  },
  {
    ...
    type: 'legal', status: 'published',
    body: 'These Terms and Conditions govern your use of Planyx. By using our platform, you agree to these terms.',
  ...
  },
  {
    ...
    body: 'This Cookie Policy explains how Planyx uses cookies and similar tracking technologies on our website.',
  ...
  },
  {
    ...
    body: 'Welcome to Planyx. This guide will walk you through creating your first document, choosing a template, and exporting your work.',
