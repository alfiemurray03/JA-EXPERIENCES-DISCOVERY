...
const SEED_CONTENT: ContentItem[] = [
  ...
  },
  {
    ...
    body: 'This Privacy Policy explains how JA Plan Studio collects, uses, and protects your personal data in accordance with the UK GDPR and the Data Protection Act 2018.',
  ...
  },
  {
    ...
    type: 'legal', status: 'published',
    body: 'These Terms and Conditions govern your use of JA Plan Studio. By using our platform, you agree to these terms.',
  ...
  },
  {
    ...
    body: 'This Cookie Policy explains how JA Plan Studio uses cookies and similar tracking technologies on our website.',
  ...
  },
  {
    ...
    body: 'Welcome to JA Plan Studio. This guide will walk you through creating your first document, choosing a template, and exporting your work.',
