...
const SEED_PAGES: SitePage[] = [
  ...
  { id: 'p-005', title: 'Terms & Conditions',  path: '/terms',               category: 'legal',     status: 'live',          seoTitle: 'Terms & Conditions — JA Plan Studio', seoDescription: 'Terms governing your use of JA Plan Studio.', lastUpdated: '2026-06-02', noindex: false },
  { id: 'p-006', title: 'Cookie Policy',       path: '/cookies',             category: 'legal',     status: 'live',          seoTitle: 'Cookie Policy — JA Plan Studio', seoDescription: 'How JA Plan Studio uses cookies and tracking technologies.', lastUpdated: '2026-06-02', noindex: false },
  { id: 'p-007', title: 'Sign In',             path: '/sign-in',             category: 'auth',      status: 'live',          seoTitle: 'Sign In — JA Plan Studio', seoDescription: 'Sign in to your JA Plan Studio account.', lastUpdated: '2026-07-16', noindex: true },
  { id: 'p-008', title: 'Register',            path: '/register',            category: 'auth',      status: 'live',          seoTitle: 'Create Account — JA Plan Studio', seoDescription: 'Create your free JA Plan Studio account.', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-009', title: 'Forgot Password',     path: '/forgot-password',     category: 'auth',      status: 'live',          seoTitle: 'Reset Password — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-010', title: 'Dashboard',           path: '/dashboard',           category: 'app',       status: 'auth-required', seoTitle: 'Dashboard — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-011', title: 'Documents',           path: '/documents',           category: 'app',       status: 'auth-required', seoTitle: 'My Documents — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-012', title: 'Builders Hub',          path: '/builders',            category: 'app',       status: 'auth-required', seoTitle: 'Document Builders — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-05', noindex: true },
  { id: 'p-013', title: 'Letter Builder',      path: '/letter-builder',      category: 'app',       status: 'auth-required', seoTitle: 'Letter Builder — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-014', title: 'Email Builder',       path: '/email-builder',       category: 'app',       status: 'auth-required', seoTitle: 'Email Builder — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-03', noindex: true },
  { id: 'p-015', title: 'Settings',            path: '/settings',            category: 'app',       status: 'auth-required', seoTitle: 'Settings — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-016', title: 'Organisation Members', path: '/org/members',        category: 'app',       status: 'auth-required', seoTitle: 'Team Members — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-017', title: 'Admin Portal',        path: '/admin',               category: 'admin',     status: 'auth-required', seoTitle: 'Admin Portal — JA Plan Studio', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
];
