...
const SEED_PAGES: SitePage[] = [
  { id: 'p-001', title: 'Homepage',            path: '/',                    category: 'marketing', status: 'live',          seoTitle: 'Planyx — Guided Planning Builders', seoDescription: 'Build personalised destination, itinerary, experience, accessibility and practical travel plans.', lastUpdated: '2026-07-16', noindex: false },
  { id: 'p-002', title: 'Pricing',             path: '/pricing',             category: 'marketing', status: 'live',          seoTitle: 'Pricing — Planyx', seoDescription: 'Choose the plan that works for you. Start free and upgrade when you need more.', lastUpdated: '2026-06-02', noindex: false },
  { id: 'p-003', title: 'Contact',             path: '/contact',             category: 'marketing', status: 'live',          seoTitle: 'Contact Us — Planyx', seoDescription: 'Get in touch with the Planyx team.', lastUpdated: '2026-06-02', noindex: false },
  { id: 'p-004', title: 'Privacy Policy',      path: '/privacy',             category: 'legal',     status: 'live',          seoTitle: 'Privacy Policy — Planyx', seoDescription: 'How Planyx collects, uses, and protects your personal data.', lastUpdated: '2026-06-02', noindex: false },
  { id: 'p-005', title: 'Terms & Conditions',  path: '/terms',               category: 'legal',     status: 'live',          seoTitle: 'Terms & Conditions — Planyx', seoDescription: 'Terms governing your use of Planyx.', lastUpdated: '2026-06-02', noindex: false },
  { id: 'p-006', title: 'Cookie Policy',       path: '/cookies',             category: 'legal',     status: 'live',          seoTitle: 'Cookie Policy — Planyx', seoDescription: 'How Planyx uses cookies and tracking technologies.', lastUpdated: '2026-06-02', noindex: false },
  { id: 'p-007', title: 'Sign In',             path: '/sign-in',             category: 'auth',      status: 'live',          seoTitle: 'Sign In — Planyx', seoDescription: 'Sign in to your Planyx account.', lastUpdated: '2026-07-16', noindex: true },
  { id: 'p-008', title: 'Register',            path: '/register',            category: 'auth',      status: 'live',          seoTitle: 'Create Account — Planyx', seoDescription: 'Create your free Planyx account.', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-009', title: 'Forgot Password',     path: '/forgot-password',     category: 'auth',      status: 'live',          seoTitle: 'Reset Password — Planyx', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-010', title: 'Dashboard',           path: '/dashboard',           category: 'app',       status: 'auth-required', seoTitle: 'Dashboard — Planyx', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-011', title: 'Documents',           path: '/documents',           category: 'app',       status: 'auth-required', seoTitle: 'My Documents — Planyx', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-012', title: 'Builders Hub',          path: '/builders',            category: 'app',       status: 'auth-required', seoTitle: 'Document Builders — Planyx', seoDescription: '', lastUpdated: '2026-06-05', noindex: true },
  { id: 'p-013', title: 'Letter Builder',      path: '/letter-builder',      category: 'app',       status: 'auth-required', seoTitle: 'Letter Builder — Planyx', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-014', title: 'Email Builder',       path: '/email-builder',       category: 'app',       status: 'auth-required', seoTitle: 'Email Builder — Planyx', seoDescription: '', lastUpdated: '2026-06-03', noindex: true },
  { id: 'p-015', title: 'Settings',            path: '/settings',            category: 'app',       status: 'auth-required', seoTitle: 'Settings — Planyx', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-016', title: 'Organisation Members', path: '/org/members',        category: 'app',       status: 'auth-required', seoTitle: 'Team Members — Planyx', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
  { id: 'p-017', title: 'Admin Portal',        path: '/admin',               category: 'admin',     status: 'auth-required', seoTitle: 'Admin Portal — Planyx', seoDescription: '', lastUpdated: '2026-06-02', noindex: true },
];
