...
// Auth — Business/Customer portal
import authCallbackGet from "./api/auth/callback/GET";
import authLogoutPost from "./api/auth/logout/POST";
import authMeGet from "./api/auth/me/GET";
import authDebugGet from "./api/auth/debug/GET";
// Auth — Admin portal
import adminAuthCallbackGet from "./api/admin/auth/callback/GET";
...
// Auth — Business/Customer portal
app.get("/api/auth/callback", authCallbackGet);
app.post("/api/auth/logout", authLogoutPost);
app.get("/api/auth/me", authMeGet);
app.get("/api/auth/debug", authDebugGet);
// Auth — Admin portal
app.get("/api/admin/auth/callback", adminAuthCallbackGet);
