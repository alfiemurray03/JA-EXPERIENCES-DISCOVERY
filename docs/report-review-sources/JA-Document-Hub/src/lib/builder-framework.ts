...
export const BUILDER_LAYOUTS: BuilderLayoutDef[] = [
  { id: 'letter',       name: 'Formal Letter',      description: 'Traditional letter with sender/recipient blocks and date line.',        suitableFor: ['letter'] },
  { id: 'modern-letter',name: 'Modern Letter',       description: 'Clean sans-serif letter with coloured header bar.',                     suitableFor: ['letter'] },
...
/** Format a date string as UK long date */
